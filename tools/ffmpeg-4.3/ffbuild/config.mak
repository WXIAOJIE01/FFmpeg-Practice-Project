...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=./install --toolchain=msvc --enable-shared --disable-programs --disable-ffplay --disable-ffmpeg --disable-ffprobe --enable-libx264 --enable-gpl --enable-libfdk-aac --enable-nonfree --enable-libx265
prefix=./install
...
CC_IDENT=用于 x86 的 Microsoft (R) C/C++ 优化编译器 19.28.29924 版
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=_
CC=cl.exe
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS -D_WIN32_WINNT=0x0600 -I$(SRC_PATH)/compat/atomics/win32
CFLAGS= -nologo    -I/usr/local/include -I/usr/local/include -DX264_API_IMPORTS -I/usr/local/include -Z7 -W3 -wd4018 -wd4146 -wd4244 -wd4305 -wd4554 -O2   -Oy- -utf-8
...
DEPWINDRES=cl.exe
DOXYGEN=doxygen
LDFLAGS= -nologo -LARGEADDRESSAWARE     -debug
LDEXEFLAGS=
LDSOFLAGS=
...
CXXDEP=$(DEP$(1)) $(DEP$(1)FLAGS) $($(1)DEP_FLAGS) $< 2>&1 | awk '/including/ { sub(/^.*file: */, ""); gsub(/\\/, "/"); if (!match($$0, / /)) print "$@:", $$0 }' > $(@:.o=.d)
CCDEP_FLAGS=$(CPPFLAGS) $(CFLAGS) -showIncludes -Zs
ASDEP=$(DEP$(1)) $(DEP$(1)FLAGS) $($(1)DEP_FLAGS) $< 2>&1 | awk '/including/ { sub(/^.*file: */, ""); gsub(/\\/, "/"); if (!match($$0, / /)) print "$@:", $$0 }' > $(@:.o=.d)
ASDEP_FLAGS=$(CPPFLAGS) $(CFLAGS) -showIncludes -Zs
X86ASMDEP=
X86ASMDEP_FLAGS=
CC_DEPFLAGS=
AS_DEPFLAGS=
...
HOSTCC=cl.exe
HOSTLD=cl.exe
HOSTCFLAGS= -nologo  -W3 -wd4018 -wd4146 -wd4244 -wd4305 -wd4554 -O2
HOSTCPPFLAGS= -D_ISOC99_SOURCE -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS -D_WIN32_WINNT=0x0600
HOSTEXESUF=.exe
HOSTLDFLAGS= -nologo
HOSTEXTRALIBS=-lm
DEPHOSTCC=cl.exe
DEPHOSTCCFLAGS=-nologo $(HOSTCCFLAGS)
HOSTCCDEP=$(DEP$(1)) $(DEP$(1)FLAGS) $($(1)DEP_FLAGS) $< 2>&1 | awk '/including/ { sub(/^.*file: */, ""); gsub(/\\/, "/"); if (!match($$0, / /)) print "$@:", $$0 }' > $(@:.o=.d)
HOSTCCDEP_FLAGS=$(CPPFLAGS) $(CFLAGS) -showIncludes -Zs
HOSTCC_DEPFLAGS=
HOSTCC_C=-c
HOSTCC_O=-Fo$@
HOSTLD_O=-Fe$@
...
avutil_FFLIBS=
EXTRALIBS-avdevice=psapi.lib ole32.lib strmiids.lib uuid.lib oleaut32.lib shlwapi.lib gdi32.lib vfw32.lib
EXTRALIBS-avfilter=
EXTRALIBS-swscale=
EXTRALIBS-postproc=
EXTRALIBS-avformat=secur32.lib ws2_32.lib
EXTRALIBS-avcodec=-libpath:/usr/local/lib fdk-aac.lib -libpath:/usr/local/lib libx264.lib -libpath:/usr/local/lib x265.lib mfplat.lib mfuuid.lib ole32.lib strmiids.lib ole32.lib user32.lib
EXTRALIBS-swresample=
EXTRALIBS-avresample=
EXTRALIBS-avutil=user32.lib bcrypt.lib
EXTRALIBS-ffplay=shell32.lib
EXTRALIBS-ffprobe=shell32.lib
EXTRALIBS-ffmpeg=ole32.lib psapi.lib shell32.lib
EXTRALIBS-cpu_init=
EXTRALIBS-cws2fws=
!ARCH_AARCH64=yes
!ARCH_ALPHA=yes
